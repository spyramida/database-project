<html>
    ...
    <?php /*
    ** Value.php---> queries to VIEW
	** CREATE ACCOUNT (Borrowers, Lender ,Intermediary) sign.php
    ** Update and Delete is the same
    **
    ** Edw ousiastika peirazoume gia to ka8e case (to 2o orisma sthn if)
    ** query: To query
    ** num_of_elements : Number of columns
    ** select_array : Column elements
    ...
    */
    ...
    if ($value == 11){//LENDER
    ...
    else if ($value == 17){//Borrowers max-trust and number of loans
        ...
        /* remaining value to satisfy a loan request, deadline BId, Date*/
        ...
        /*list pending deadlines gia lender, till a date, input lender date*/
