<?php /*
** Edw einai to index. Sto index mesw enos menu (pou den allazei selida)
** o xrhsths dialegei ti einai (Borrower Lender Intermediary). Tou vgainei 
** h lista me tis epiloges, kai analogws ti einai kai ti 8a pathsei
** h metavlhth "value" pairnei diaforetikh timh. Kanoume include to value.php
** to opoio analoga me thn timh tou value kalei ta katallhla queries
** OPOTE, CHECH value.php
*/?>
